...
namespace Fitness.Tests.Services
{
	public class WorkoutSessionServiceTests
	{
		...
		private readonly Mock<IExerciseLogService> _exerciseLogServiceMock = new();
		private readonly Mock<IMapper> _mapperMock = new();

		private WorkoutSessionService WorkoutSessionService() =>
			new(_workoutSessionRepositoryMock.Object, _workoutTemplateRepositoryMock.Object, _exerciseLogServiceMock.Object, _mapperMock.Object);
		...
		public async Task CreateWorkoutSessionAsync_WhenTemplateExists_ShouldCreateSession()
		{
			...
			_workoutTemplateRepositoryMock
				.Setup(r => r.GetWorkoutTemplateByIdWithExercises(_workoutTemplateId))
				.ReturnsAsync(workoutTemplate);

			_exerciseLogServiceMock
				.Setup(s => s.CreateExerciseLogsFromWorkoutTemplateExercises(It.IsAny<List<WorkoutTemplateExercise>>()))
				.Returns([]);
			...
			_workoutTemplateRepositoryMock.Verify(r => r.GetWorkoutTemplateByIdWithExercises(_workoutTemplateId), Times.Once);
		...
		public async Task GetWorkoutSessionByIdAsync_WhenFound_ShouldReturnDto()
		{
			...
			_workoutSessionRepositoryMock
				.Setup(r => r.GetWorkoutSessionByIdWithExerciseLogs(_workoutSessionId))
				.ReturnsAsync(workoutSession);
			...
			_workoutSessionRepositoryMock.Verify(r => r.GetWorkoutSessionByIdWithExerciseLogs(_workoutSessionId), Times.Once);
